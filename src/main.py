...
if __name__ == "__main__":
    ...
    players = [
        ...
        Player(GREEN, "Green", Direction.DOWN, player_is_AI=True, ai_agent=ai_agent_minmax_depth1),  # Green
        Player(BLUE, "Blue", Direction.LEFT, player_is_AI=True, ai_agent=ai_agent_minmax_depth1),  # Blue
        Player(YELLOW, "Yellow", Direction.RIGHT, player_is_AI=True, ai_agent=ai_agent_minmax_depth1)  # Yellow
    ]
